...
const productData = [
  // Decentralized
  { id: 'xInc', name: 'xInc', category: 'Decentralized', image: '🔗', 
  ...
  { id: 'xAlarm', name: 'xAlarm', category: 'Decentralized', image: '🌐',
...
'Wide operating temperature range.'
  ...
  { id: 'xStrain', name: 'xStrain', category: 'Decentralized', image: '📡', overview: 'xStrain – Flexible, Reliable Strain Monitoring xStrain is an affordable and adaptable solution for monitoring Wheatstone Bridge sensors in harsh environments. Ideal for field and remote data acquisition of low-voltage output sensors, it features a compact, rugged design certified for industrial use from -40°C to 55°C. Operate it as a standalone unit or integrate it into a network for easy installation. With a variety of sensor options, xStrain delivers precise monitoring and long-term reliable performance.',
...
'Wide operating temperature range (-40°C to 85°C) for extreme conditions.'
  ...
  // Centralized
  { id: 'xRover', name: 'xRover', category: 'Centralized', image: '🏢', overview: 'Experience precision and reliability with xRover. This custom-configured high-performance system delivers multi-channel, real-time data acquisition and structural analysis. It supports user-defined sampling rates and integrates seamlessly with all sensor types. Built in a durable, compact design, it ensures reliable performance even in harsh environments. With secure cloud-based tools, you can access real-time data and generate automated PDF reports from any internet-enabled device.',
...
'High precision and long-term dependability with simple installation.'
  ...
  // All-in-One
  { id: 'xWave Max', name: 'xWave Max', category: 'All-in-One', image: '�', overview: 'The xWave Max represents a new benchmark in Structural Health Monitoring (SHM). This fully digital standalone unit is engineered for harsh environments and confined spaces, delivering precise control and advanced data acquisition in a compact rugged design. With an operating range from -40 °C to +55 °C and compliance with international safety and EMC standards, it is a reliable choice for a wide variety of SHM applications.',
      imgSrc: '/products/download/image.png' },
  // Portable
  { id: 'xWave-Ambient', name: 'xWave-Ambient', category: 'Portable', image: '📱', overview: 'Introducing a next-generation wireless solution for Structural Health Monitoring. With a self-healing algorithm, the system ensures seamless data transmission, even if some sensors temporarily lose connection. Devices communicate directly with each other, enhancing reliability and reducing dependency on gateways. Supporting standard Wi-Fi protocols (802.11n/g/b), it enables easy coverage extension and hassle-free sensor connectivity—no advanced network expertise required. Designed with portability in mind, its 12+ hour battery life makes it ideal for field measurements. Upgrade your SHM system with a smarter, more reliable wireless network.',
...
'Internal battery for 24 hours of operation plus charging support for connected nodes.'
  ...
  { id: 'Carry Box', name: 'Carry Box', category: 'Portable', image: '�', overview: 'Ambient Equipment Carry Box', features: ['Equipment storage', 'Portable', 'Durable'], imgSrc: '/products/items/portable/portable2-16.png' },
  { id: 'xNet-Ambient', name: 'xNet-Ambient', category: 'Portable', image: '🔋', overview: 'Introducing a next-generation wireless solution for Structural Health Monitoring. With a self-healing algorithm, the system ensures seamless data transmission, even if some sensors temporarily lose connection. Devices communicate directly with each other, enhancing reliability and reducing dependency on gateways. Supporting standard Wi-Fi protocols (802.11n/g/b), it enables easy coverage extension and hassle-free sensor connectivity—no advanced network expertise required. Designed with portability in mind, its 12+ hour battery life makes it ideal for field measurements. Upgrade your SHM system with a smarter, more reliable wireless network.',
