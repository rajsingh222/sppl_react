          ...
          <div className="w-full max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16 text-white">
              ...
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                ...
                <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-300 to-blue-400">Building</span> Monitoring</h3>
                <div className="h-1 w-16 bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-400 rounded-full" />
                <p className="text-slate-100 leading-relaxed text-base md:text-lg max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.7)]">Structures evolve under load, environment and aging—continuous sensing uncovers subtle changes so you can act before performance is impaired.</p>
              </div>
              {/* Approach Card */}
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                ...
                <ul className="text-slate-100 text-base md:text-lg leading-relaxed space-y-3 max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.55)]">
                  {[
                    ...
                    'Real-time condition dashboards & alerts',
                    'Predictive analytics for remaining life',
                    'Custom deployments by building type'
                  ].map(item => (
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="grid md:grid-cols-2 gap-14 md:gap-20 items-start">
            <div className="space-y-6">
              <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Operational & Structural Advantages</h3>
              <ul className="space-y-5 text-lg text-slate-700">
                {[
                  'Early detection of cracks & movement',
                  'Increased occupant safety',
                  'Planned maintenance to reduce cost',
            ...
            <div className="relative group flex items-center justify-center">
              ...
              <div className="relative rounded-2xl bg-white/85 backdrop-blur-xl ring-1 ring-slate-200 shadow-[0_8px_32px_-10px_rgba(30,64,175,0.25)] flex items-center justify-center h-full w-full p-8 md:p-10">
                <h3 className="text-center leading-tight">
                  <span className="block text-3xl md:text-4xl font-extrabold tracking-tight text-slate-800">Advantages of Our</span>
                  <span className="block text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-600 via-blue-600 to-cyan-500 bg-clip-text text-transparent mt-1">Solution</span>
                </h3>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid gap-6 sm:gap-7 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            {[
              ...
              '🏛️ Heritage & historical buildings',
              '🏟️ Stadiums, auditoriums, & public spaces'
            ].map(text => {
