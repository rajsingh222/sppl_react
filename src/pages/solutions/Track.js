        ...
        <div className="relative h-full flex items-center px-8 md:px-16">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight text-white drop-shadow-lg">
              <span className="bg-gradient-to-r from-sky-300 via-blue-300 to-cyan-300 bg-clip-text text-transparent">Track</span>{' '}Health Monitoring
            </h1>
            <p className="mt-6 text-lg md:text-2xl font-medium text-blue-100 max-w-3xl leading-relaxed">Rail & transit track integrity through continuous geometry, vibration & settlement intelligence.</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-slate-900">
                <span className="block">Proactive</span>
                ...
                <span className="block text-slate-800 mt-2">Integrity</span>
              </h2>
            </div>
            <div className="text-slate-800 text-lg leading-relaxed space-y-6">
              <p>We enable predictive maintenance through continuous measurement of geometry evolution, dynamic loading, settlement profile and fastening performance.</p>
              <p>Automated analytics highlight emerging degradation, prioritize tamping / renewal and reduce operational risk and downtime.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="w-full max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16 text-white">
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-300 to-blue-400">Track</span> Monitoring</h3>
                <div className="h-1 w-16 bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-400 rounded-full" />
                <p className="text-slate-100 leading-relaxed text-base md:text-lg max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.65)]">High axle loads, temperature cycles and settlement drive geometry degradation. Early drift detection prevents speed restrictions & failures.</p>
              </div>
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                ...
                <ul className="text-slate-100 text-base md:text-lg leading-relaxed space-y-3 max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.55)]">
                  {[
                    'Geometry & alignment drift tracking',
                    'Vibration & impact energy signatures',
                    'Differential settlement profiling',
                    'Fastener & ballast condition analytics'
                  ].map(item => (
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="grid md:grid-cols-2 gap-14 md:gap-20 items-start">
            <div className="space-y-6">
              <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Operational Advantages</h3>
              <ul className="space-y-5 text-lg text-slate-700">
                {[
                  'Reduced manual inspection frequency',
                  'Predictive tamping & renewal planning',
                  'Speed restriction risk mitigation',
            ...
            <div className="relative group flex items-center justify-center">
              ...
              <div className="relative rounded-2xl bg-white/85 backdrop-blur-xl ring-1 ring-slate-200 shadow-[0_8px_32px_-10px_rgba(30,64,175,0.25)] flex items-center justify-center h-full w-full p-8 md:p-10">
                <h3 className="text-center leading-tight">
                  <span className="block text-3xl md:text-4xl font-extrabold tracking-tight text-slate-800">Track Insight</span>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid gap-6 sm:gap-7 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            {[
              ...
              '🚇 Metro & urban transit',
              '🛤️ High-speed rail segments',
              '🏭 Industrial rail spurs',
              '⚙️ Depot & yard infrastructure'
            ].map(text => {
