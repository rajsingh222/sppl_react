...
const bgImages = [
  ...
  '/solution/t5.jpg',
  '/solution/t1.jpg'
]; // TODO: replace with tunnel specific images
        ...
        <div className="relative h-full flex items-center px-8 md:px-16">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight text-white drop-shadow-lg">
              <span className="bg-gradient-to-r from-sky-300 via-blue-300 to-cyan-300 bg-clip-text text-transparent">High-Quality</span>{' '}Solutions for Tunnels
            </h1>
            <p className="mt-6 text-lg md:text-2xl font-medium text-blue-100 max-w-3xl leading-relaxed">Providing advanced monitoring systems that safeguard against ground movement, seepage, and structural risks throughout construction and operation.</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 pl-3 border-l-4 border-sky-500/80">
                <span className="text-xs tracking-widest font-medium text-slate-600 uppercase">Integrity & Safety</span>
              </div>
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-slate-900">
                  <span className="block">Comprehensive</span>
                <span className="block mt-3"><span className="bg-gradient-to-r from-sky-600 via-blue-500 to-cyan-400 bg-clip-text text-transparent">Tunnel</span></span>
          ...
          <div className="w-full max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16 text-white">
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-300 to-blue-400">Tunnel</span> Monitoring Matters</h3>
                <div className="h-1 w-16 bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-400 rounded-full" />
                <p className="text-slate-100 leading-relaxed text-base md:text-lg max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.65)]">Tunnels are exposed to complex challenges such as ground movement, water seepage, and stress during excavation. Without monitoring, these hidden risks can escalate into structural failures, costly delays, and serious safety hazards.</p>
              </div>
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                ...
                <ul className="text-slate-100 text-base md:text-lg leading-relaxed space-y-3 max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.55)]">
                  {[
                    'Geotechnical instruments for ground & structural monitoring',  
'Sensors to measure stress, deformation & vibration',  
'Seepage detection & water ingress monitoring',  
'Real-time dashboards with alerts & reporting',  
'Customized systems for construction & operational phases'  
          ...
          <div className="grid md:grid-cols-2 gap-14 md:gap-20 items-stretch">
            ...
            <div className="rounded-2xl p-6 md:p-8 ring-1 ring-slate-200 bg-white/90 backdrop-blur-sm shadow-sm flex flex-col h-full justify-between">
              ...
              <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-[15px] text-slate-700">
                {[
                  'Early detection of ground movement & seepage',  
'Improved safety for workers & commuters',  
'Reduced risk of structural failures or collapses',  
'Optimized maintenance planning & reduced costs',  
'Extended tunnel service life'  
                ].map(item => (
            ...
            <div className="rounded-2xl p-6 md:p-8 ring-1 ring-slate-200 bg-white/90 backdrop-blur-sm shadow-sm flex flex-col h-full justify-between">
              ...
              <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                <div className="px-2">
                  <div className="text-2xl md:text-3xl font-extrabold text-slate-800">35%</div>
                  <div className="text-[11px] md:text-xs text-slate-600 leading-snug">Fewer unplanned works</div>
                </div>
                <div className="px-2">
                  <div className="text-2xl md:text-3xl font-extrabold text-slate-800">2x</div>
                  <div className="text-[11px] md:text-xs text-slate-600 leading-snug">Faster ingress alerts</div>
                </div>
                <div className="px-2">
      ...
      <section className="relative pt-20 pb-6 bg-white">
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid gap-6 sm:gap-7 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            {[
              { icon: '🛣️', label: 'Road & expressway tunnels' },
              { icon: '🚇', label: 'Metro & railway tunnels' },
              { icon: '🔌', label: 'Utility tunnels for water, power & pipelines' },
              { icon: '⛏️', label: 'Mining tunnels & underground works' },
              { icon: '🏙️', label: 'Critical urban infrastructure tunnels' }
            ].map(({ icon, label }) => (
