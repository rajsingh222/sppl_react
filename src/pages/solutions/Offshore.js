        ...
        <div className="relative h-full flex items-center px-8 md:px-16">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight text-white drop-shadow-lg">
              <span className="bg-gradient-to-r from-sky-300 via-blue-300 to-cyan-300 bg-clip-text text-transparent">Reliable Solutions</span>{' '}for Offshore & Hydraulic Structure Monitoring
            </h1>
            <p className="mt-6 text-lg md:text-2xl font-medium text-blue-100 max-w-3xl leading-relaxed"></p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-slate-900">
                ...
                <span className="block mt-3"><span className="bg-gradient-to-r from-sky-600 via-blue-500 to-cyan-400 bg-clip-text text-transparent">Offshore & Hydraulic Structures</span></span>
...
<p>We provide real-time monitoring systems for offshore platforms, dams, and hydraulic structures, detecting stress, vibration, water pressure changes, and structural movement to ensure safety and reliability.</p>
<p>Our expertise delivers cost-effective solutions that prevent failures, optimize maintenance, and extend the lifespan of critical water and offshore infrastructure.</p>
          ...
          <div className="w-full max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16 text-white">
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-300 to-blue-400">Offshore & Hydraulic</span> Monitoring Matters</h3>
                <div className="h-1 w-16 bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-400 rounded-full" />
                <p className="text-slate-100 leading-relaxed text-base md:text-lg max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.65)]">Offshore and hydraulic structures face continuous environmental loads, waves, currents, and operational stresses. Without monitoring, small defects can escalate into structural failures, costly downtime or safety hazards</p>
              </div>
              <div className="relative space-y-5 pl-4 rounded-xl p-6 backdrop-blur-xl bg-gradient-to-br from-slate-900/55 via-slate-800/45 to-slate-900/50 ring-1 ring-white/10 shadow-[0_6px_22px_-6px_rgba(0,0,0,0.45)]">
                ...
                <ul className="text-slate-100 text-base md:text-lg leading-relaxed space-y-3 max-w-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.55)]">
                  {[
                    'Sensors for stress, vibration, tilt, and water pressure monitoring',
                    'Real-time dashboards with instant alerts',
                    'Predictive analytics for early failure detection',
                    'Tailored solutions for dams, hydraulic systems, and offshore platforms'
                  ].map((item) => (
            ...
            <div className="rounded-2xl p-6 md:p-8 ring-1 ring-slate-200 bg-white/90 backdrop-blur-sm shadow-sm flex flex-col h-full justify-between">
              ...
              <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-[15px] text-slate-700">
                {[
                  ...
                  'Extend service life of offshore and hydraulic infrastructure',
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid gap-6 sm:gap-7 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            {[
              ...
              'Dams, spillways, and weirs',
              'Hydraulic tunnels and canals',
                ...
                <div className="relative flex flex-col gap-4">
                  <div className="flex items-start gap-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white ring-1 ring-slate-200 text-3xl select-none shadow-sm">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className="h-7 w-7 text-sky-600"><path strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" d="M3 12c2 0 2-2 4-2s2 2 4 2 2-2 4-2 2 2 4 2"/></svg>
                    </div>
