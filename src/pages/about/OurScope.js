      ...
      <div className="pt-20">
        <div className="relative text-center py-16 bg-gradient-to-r from-sppl-blue to-sppl-dark-blue text-white overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Our Scope</h1>
            <p className="text-lg md:text-xl text-blue-100">Where and how SPPL solutions are applied.</p>
        ...
        <section className="py-16">
          <div className="max-w-5xl mx-auto px-6 text-gray-800 space-y-4">
            <p>We work across bridges, rail networks, metros, and other critical infrastructure domains.</p>
          </div>
        </section>
      </div>
      <Footer />
