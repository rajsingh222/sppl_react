                ...
                <div className="mt-5 grid sm:grid-cols-2 gap-4">
                  {[{
                    ...
                    <Reveal key={f.title} delay={i*70}>
                      <div className="h-full bg-gradient-to-br from-blue-50 via-white to-sky-50 rounded-xl border border-blue-100 p-4 shadow-sm hover:shadow-md transition-all">
