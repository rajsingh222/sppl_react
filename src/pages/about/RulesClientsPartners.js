      ...
      <div className="pt-20">
        <div className="relative text-center py-16 bg-gradient-to-r from-sppl-blue to-sppl-dark-blue text-white overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Rules for Clients & Partners</h1>
            <p className="text-lg md:text-xl text-blue-100">Working practices and expectations for successful collaboration.</p>
